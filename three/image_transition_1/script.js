...
// loadScript('//cdnjs.cloudflare.com/ajax/libs/three.js/r75/three.min.js');
// loadScript('//cdnjs.cloudflare.com/ajax/libs/gsap/1.18.0/TweenMax.min.js');
// loadScript('https://s3-us-west-2.amazonaws.com/s.cdpn.io/175711/bas2.js');
...
function init() {
  var root = new THREERoot({
    createCameraControls: !true,  // camera control : false
